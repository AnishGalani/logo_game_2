...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    print(MyApp.prefs?.getString('level${0}${0}'));
    return WillPopScope(
      child: SafeArea(
        child: Scaffold(
          body: FutureBuilder(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      alignment: Alignment.centerLeft,
                                      child: Text("LOGO GAME",style: TextStyle(fontSize: 10,color: Colors.black)),
                              ...
                              child: GestureDetector(onTapUp:(details) {
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      gradient: LinearGradient(colors: [Colors.grey,Colors.grey.shade400]), shape: BoxShape.circle),
                                ),
                              ),
                              decoration: BoxDecoration(color: Colors.white),
                            )),
